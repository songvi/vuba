 ...
 */
class User extends \VuBa\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'id', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'sid', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'display_name', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'title', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'sex', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'description', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'create_at', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'auth_source', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'user_type', '' . "\0" . 'VuBa\\Entities\\User' . "\0" . 'is_locked'];
        }
